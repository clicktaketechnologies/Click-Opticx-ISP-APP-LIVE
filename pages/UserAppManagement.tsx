...
const UserAppManagement: React.FC<{ state: AppState }> = ({ state }) => {
  ...
  const handleApproveSignup = async (id: string) => {
    ...
    setIsProcessing(null);
    db.logNotification('all', 'success', 'Node Provisioned', 'Subscriber signup request authorized.');
  };
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 font-medium">Control subscriber terminal nodes and UI handshakes.</p>
        </div>
           ...
           <div className="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm">
              <div className="relative">
                 ...
                 <input 
                   ...
                   placeholder="Lookup subscriber terminal..."
                   value={searchTerm}
                 ...
                 <table className="w-full text-left">
                    <thead className="bg-slate-50 border-b border-slate-100">
                       <tr>
                          ...
                          <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Link Ref</th>
              ...
              {signupRequests.map(req => (
                <div key={req.id} className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6 group hover:shadow-xl transition-all">
                   <div className="flex justify-between items-start">
                      ...
                      <span className="text-[8px] font-black text-blue-500 bg-blue-50 px-2 py-1 rounded-full uppercase tracking-widest">New Node Request</span>
                   </div>
                   <div>
                   ...
                   <div className="flex gap-2">
                      ...
                      >
                         {isProcessing === req.id ? <RefreshCw className="animate-spin" size={12}/> : <CheckCircle size={12}/>} Approve
                      </button>
                   </div>
                </div>
              ))}
                   ...
                   <div className="space-y-8">
                      ...
                      <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-6">
                         <div className="flex justify-between items-center">
                            <h4 className="text-[10px] font-black text-indigo-400 uppercase tracking-widest flex items-center gap-2"><Zap size={14}/> Node Registry Mapping</h4>
                         ...
                         <div className="grid grid-cols-1 gap-2 max-h-48 overflow-y-auto custom-scrollbar pr-2">
                            ...
                            {editingSection.itemIds.length === 0 && (
                               <p className="text-[9px] font-black text-slate-600 uppercase text-center py-4 italic">No functional nodes linked to this logic group</p>
                            )}
                         </div>
                      </div>
                   </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 animate-in slide-in-from-right-4 duration-500">
           ...
           <div className="bg-slate-900 rounded-[3rem] p-10 text-white space-y-10 shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                 ...
                 <p className="text-[9px] text-slate-500 font-black uppercase mt-2 tracking-widest">Master Switches for User App Modules</p>
              </div>
              ...
              <div className="relative z-10 space-y-4">
                 {[
                   ...
                   { label: 'Fiscal Wallet Hub', key: 'showWallet', icon: Wallet, color: 'text-emerald-400', bg: 'bg-emerald-500/10', desc: 'User-managed liquidity node.' },
           ...
           <div className="bg-white rounded-[3.5rem] border border-slate-100 p-10 shadow-sm flex flex-col space-y-10">
              <div className="flex justify-between items-center">
                 <div>
                    <h3 className="text-lg font-black text-slate-900 uppercase tracking-tighter italic leading-none">Individual Node Config</h3>
           ...
           <div className="p-8 border-b bg-slate-950 text-white flex justify-between items-center shrink-0">
              <div className="flex items-center gap-4">
                 ...
                 <div>
                    ...
                    <p className="text-indigo-400 text-[10px] font-black uppercase tracking-[0.4em]">Handshake Audit Trail v8.5</p>
                 </div>
              </div>
                      ...
                      <tr key={log.id} className="hover:bg-white transition-colors group">
                         ...
                         <td className="px-8 py-5">
                            <span className={`px-2 py-0.5 rounded text-[8px] font-black uppercase border ${
                              log.riskLevel === 'Critical' ? 'bg-rose-50 text-rose-600 border-rose-100' :
