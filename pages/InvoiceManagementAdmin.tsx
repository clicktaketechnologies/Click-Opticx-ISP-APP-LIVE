                      ...
                      <tr key={inv.id} className={`hover:bg-slate-50 transition-colors group ${selectedIds.has(inv.id) ? 'bg-indigo-50/50' : ''}`}>
                        ...
                        <td className="px-8 py-6 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              className="p-2.5 bg-indigo-50 border border-indigo-200 text-indigo-600 hover:bg-indigo-600 hover:text-white rounded-xl shadow-sm transition-all"
                              title="View Invoice"
                            ...
                            {inv.status !== PaymentStatus.PAID && (
                              <button
                                className="p-2.5 bg-emerald-50 border border-emerald-200 text-emerald-600 hover:bg-emerald-600 hover:text-white rounded-xl shadow-sm transition-all"
                                title="Mark as Paid"
