    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <h3 className="text-3xl font-black text-slate-900 mt-2 tracking-tight relative z-10">Rs. {(stats.distributed || 0).toLocaleString()}</h3>
         ...
         <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <h3 className="text-3xl font-black text-green-600 mt-2 tracking-tight relative z-10">Rs. {(stats.paid || 0).toLocaleString()}</h3>
         ...
         <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <h3 className="text-3xl font-black text-orange-600 mt-2 tracking-tight relative z-10">Rs. {(stats.pending || 0).toLocaleString()}</h3>
