...
const PaymentGatewaySettings: React.FC<{ state: AppState }> = ({ state }) => {
  ...
  const handleSaveConfig = async () => {
    ...
    setTimeout(() => {
      ...
      db.logNotification('all', 'success', 'Config Synchronized', `${selectedGateway.name} handshake parameters updated.`);
    }, 600);
  };
            ...
            <div className="p-10 border-b bg-slate-50 flex justify-between items-center shrink-0">
               <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Handshake Interface Node</p>
                  </div>
               </div>
            ...
            <div className="p-10 space-y-10 overflow-y-auto custom-scrollbar flex-1">
               ...
               <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Handshake Parameters</h4>
                    <button 
