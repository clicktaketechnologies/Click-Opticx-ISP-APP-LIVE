                         ...
                         {entry.type === LedgerType.DEBIT ? (
                           <div className="flex items-center justify-end gap-2">
                             ...
                             <div className="flex flex-col items-end">
                               <span className="text-sm font-black text-rose-600 tabular-nums">-{state.settings.currency}{(entry.amount || 0).toLocaleString()}</span>
                           ...
                           <div className="flex items-center justify-end gap-2">
                             ...
                             <div className="flex flex-col items-end">
                               <span className="text-sm font-black text-emerald-600 tabular-nums">+{state.settings.currency}{(entry.amount || 0).toLocaleString()}</span>
