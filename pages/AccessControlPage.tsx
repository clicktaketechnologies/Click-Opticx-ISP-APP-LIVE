...
import {
  ...
  Check, Ban, Pencil, Trash2, Activity, LayoutDashboard, Brain, Mic, FileAudio, FileText, Terminal, Bell, Monitor, Server, Map, UserCircle, Smartphone, Briefcase, Receipt, CreditCard, Flame, Wallet, Landmark, Zap, Layers, FileInput, Archive, UserCheck, Globe, Headphones, RefreshCw, ChevronRight, Sparkles
} from 'lucide-react';
