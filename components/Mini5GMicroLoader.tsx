    ...
    const renderStyle = () => {
        switch (activeStyle) {
            ...
            case 'Orbit':
                return (
                    <div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
                        <div className="absolute inset-0 border-2 border-dashed border-indigo-400/30 rounded-full animate-[spin_10s_linear_infinite]" />
                        ...
                        <Loader2 size={size * 0.8} className="text-indigo-400 animate-spin" />
            ...
            default:
                return (
                    <div className={`relative flex items-center justify-center shrink-0 ${className}`} style={{ width: size, height: size }}>
                        {/* Core Spinner Rings */}
                        <div className="absolute inset-0 rounded-full border-[1.5px] border-indigo-500/40 animate-[spin_2.5s_linear_infinite]" />
                        ...
                        <div className="absolute inset-[25%] rounded-full border-b-[2px] border-l-[2px] border-emerald-400 animate-[spin_1.2s_linear_infinite]" />
                        ...
                        {size > 30 && (
                            <span className="absolute -bottom-1 right-0 text-[8px] font-black text-emerald-400 drop-shadow-sm select-none">5G</span>
                        )}
                    </div>
                );
        }
