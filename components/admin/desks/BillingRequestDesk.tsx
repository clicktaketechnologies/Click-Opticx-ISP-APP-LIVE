                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div className="overflow-hidden">
                        ...
                        <p className="text-[9px] font-black text-blue-500 uppercase tracking-widest mt-2">{state.settings.currency} {(req.amount || 0).toLocaleString()}</p>
                      </div>
                    </div>
                 ...
                 <div className="p-10 bg-slate-900 text-white flex justify-between items-center relative overflow-hidden">
                    <div className="relative z-10 flex items-center gap-8">
                       ...
                       <div>
                          ...
                          <h3 className="text-5xl font-black uppercase italic tracking-tighter leading-none">{state.settings.currency} {(selectedRequest.amount || 0).toLocaleString()}</h3>
