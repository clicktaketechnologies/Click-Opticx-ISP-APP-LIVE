         ...
         <div className="grid grid-cols-2 gap-4">
            {isAdmin && (
              <button 
                ...
                className="p-8 bg-slate-950 rounded-[2.5rem] border border-blue-900/20 hover:bg-blue-900 transition-all text-left group shadow-2xl col-span-2"
              >
                 <Cpu size={28} className="text-blue-400 group-hover:text-white mb-4 group-hover:scale-110 transition-transform animate-pulse" />
                 <h4 className="text-[11px] font-black uppercase tracking-widest leading-none text-white">Full AI Control Plane</h4>
                 <p className="text-[8px] font-bold mt-2 uppercase opacity-60 text-blue-200">Administrative Oversight Handshake</p>
              </button>
            )}
            <button 
            ...
            <button 
              ...
              className="p-8 bg-green-50 rounded-[2.5rem] border border-green-100 hover:bg-green-600 hover:text-white transition-all text-left group shadow-lg shadow-green-100"
            >
               <Globe size={28} className="text-green-600 group-hover:text-white mb-4 group-hover:rotate-180 transition-transform duration-700" />
            ...
            >
               <Gauge size={28} className="text-slate-900 group-hover:text-green-400 mb-4 group-hover:scale-110 transition-transform" />
