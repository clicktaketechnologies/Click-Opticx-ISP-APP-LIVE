    ...
    <div className="space-y-8 pb-24 animate-in fade-in duration-500">
      <div className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-xl flex flex-col items-center text-center space-y-10 relative overflow-hidden">
        <div className="space-y-2 relative z-10">
          <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.4em]">Diagnostics Protocol</h3>
          <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase italic">Network Handshake</h2>
        </div>
      ...
      <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white space-y-8 shadow-2xl relative overflow-hidden">
         <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2"><Globe size={14} className="text-blue-400"/> Connection Artifacts</h4>
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            {[
              { label: 'Public IP Node', value: '182.164.3.42', icon: Wifi },
              { label: 'MAC Identity', value: 'E4:A1:7F:C2:08', icon: ShieldCheck },
              { label: 'Regional POP', value: 'KHI-NORTH-B2', icon: HardDrive },
