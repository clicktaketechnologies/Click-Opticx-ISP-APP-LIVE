      ...
      <div className="space-y-8 animate-in slide-in-from-right duration-500 pb-24">
         <div className="flex items-center gap-4 px-2">
            ...
            <div>
               ...
               <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.4em] mt-1">Registry Authority Node</p>
            </div>
         </div>
         ...
         <div className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-sm space-y-10">
            ...
            <div className="p-6 bg-slate-900 rounded-[2.5rem] flex items-center justify-between text-white relative overflow-hidden">
               <div className="relative z-10">
                  <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1 italic">Authorized Registry Document</p>
                  <h4 className="text-xl font-black text-indigo-400 uppercase italic">v8.5 Verified</h4>
               </div>
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-24">
      <div className="flex items-center gap-4 px-2">
         ...
         <div>
            ...
            <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.4em] mt-1">Governance & Compliance Registry</p>
         </div>
      </div>
      ...
      <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden shadow-2xl">
         <div className="relative z-10 space-y-6">
            <div className="flex items-center gap-3 text-indigo-400">
               <ShieldCheck size={28} />
               <h3 className="text-xl font-black uppercase tracking-tight italic">Protocol Terms</h3>
            </div>
            <p className="text-sm font-bold text-slate-400 leading-relaxed uppercase opacity-80 italic">
               Review authorized service agreements and regional compliance policies for your node identity.
            </p>
         </div>
           ...
           >
              <div className="flex items-center gap-6">
                 ...
                 <div>
                    ...
                    <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-1">Registry Handshake Node</p>
                 </div>
              </div>
      ...
      <div className="p-8 bg-amber-50 border border-amber-100 rounded-[3rem] flex items-start gap-6 shadow-sm mx-1">
         ...
         <div className="flex-1">
            <p className="text-[11px] font-black text-amber-900 uppercase tracking-widest mb-1 italic">Compliance Registry</p>
            <p className="text-[9px] text-amber-700 font-bold leading-relaxed uppercase opacity-80">
               By using any functional service tier, your identity node automatically acknowledges and binds to the Master Service Agreement v8.5.
            </p>
         </div>
      </div>
    </div>
